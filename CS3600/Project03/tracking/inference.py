    ...
    def elapseTime(self, gameState):
        ...
        *** GORY DETAIL AHEAD ***
        ...
        for position in self.legalPositions:
            ...
            for newPosition, prob in distance.items():
                newBeliefs[newPosition] += prob * self.beliefs[position]
...
class ParticleFilter(InferenceModule):
        ...
        if noisyDistance is None:
            ...
            for pos in self.legalPositions:
                ...
                if emissionModel[dist] > 0:
                    allPossible[pos] = emissionModel[dist] * beliefs[pos]
    ...
    def elapseTime(self, gameState):
        ...
        for i in range(self.numParticles):
            ...
            if newDist[pos] == 0:
                newDist[pos] = self.getPositionDistribution(self.setGhostPosition(gameState, pos))
            self.particles[i] = util.sample(newDist[pos])
    ...
    def getBeliefDistribution(self):
        ...
        for i in self.particles:
            beliefs[i] += 1.0 / self.numParticles
        return beliefs
...
class JointParticleFilter:
    ...
    def initializeParticles(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        positionSpace = list(product(self.legalPositions, repeat=self.numGhosts))
        random.shuffle(positionSpace)
        self.particles = []
        for i in range(self.numParticles):
            self.particles.append(positionSpace[i % len(positionSpace)])
        ...
        for i in range(self.numGhosts):
            if noisyDistances[i] is None:
                ...
                for particle in beliefs:
                    ...
                    beliefs[particle] *= emissionModels[i][dist]
    ...
    def elapseTime(self, gameState):
        ...
        **Note** that you may need to replace "prevGhostPositions" with the
        ...
        for oldParticle in self.particles:
            ...
            for i in range(self.numGhosts):
                newParticle[i] = util.sample(newPosDist[oldParticle][i])
            "*** END YOUR CODE HERE ***"
