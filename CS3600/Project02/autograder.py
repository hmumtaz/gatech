# import sys
import argparse
import Project2.Project.BinaryCSP
import traceback
from os import listdir
from Project2.Project.Testing import get_lines, csp_parse, assignment_parse
import time
...
def run_test(test_file_name):
    ...
    try:
        with open(test_file_name) as test_file:
            test_function = getattr(Project2.Project.BinaryCSP, test_file.readline().strip())
            for line in test_file:
                ...
                if line_type == 'csp':
                    ...
                    if line[1]=='noInferences':
                    	...
                    	args.append(fnMonitor.getFunctionMock(getattr(Project2.Project.BinaryCSP, line[1])))
                elif line_type == 'constraint':
                    args.append(getattr(Project2.Project.BinaryCSP, line[1])(*line[2:]))
